export const defaultData = {
    defaultWorkData: [{
        ...
        description: "Led cross-functional teams on software development projects with budgets up to $500k. Improved delivery timelines by 20% through streamlined processes and agile methodologies. Managed stakeholder communications and weekly reporting.",
        form: "work",
